...
public class HouseRegisterRequest implements RequestVerify {
    ...
    private List<RentalRegisterRequest> rentalRegisterRequestList; // 임대료 등록 정보 목록
    ...
    public void verify() {
        ...
        rentalRegisterRequestList.forEach(RentalRegisterRequest::verify); // 임대료 정보 Request 유효성 검사
    }
}
