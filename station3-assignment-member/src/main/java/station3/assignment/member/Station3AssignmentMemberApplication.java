package station3.assignment.member;
...
public class Station3AssignmentMemberApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(Station3AssignmentMemberApplication.class, args);
